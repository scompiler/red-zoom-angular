...
var NgxRedZoomDirective = /** @class */ (function () {
    function NgxRedZoomDirective(element, renderer, zone, document) {
        ...
        function (event, endEventName) {
             ...
             */
            function (wheelEvent) {
                if (!wheelEvent.cancelable || !_this.imagesLoaded || !_this.wheel) {
                    return;
                }
                ...
                if (_this.windowImage.width != Math.round(_this.windowImageMeta.w * _this.windowImageMeta.z)) {
                    _this.windowImageMeta.z = _this.windowImage.width / _this.windowImageMeta.w;
                    _this.windowImage.style.width = _this.windowImageMeta.w * _this.windowImageMeta.z + "px";
                    _this.windowImage.style.height = _this.windowImageMeta.h * _this.windowImageMeta.z + "px";
                }
                if (_this.windowImage.height != Math.round(_this.windowImageMeta.h * _this.windowImageMeta.z)) {
                    _this.windowImageMeta.z = _this.windowImage.height / _this.windowImageMeta.h;
                    _this.windowImage.style.width = _this.windowImageMeta.w * _this.windowImageMeta.z + "px";
                    _this.windowImage.style.height = _this.windowImageMeta.h * _this.windowImageMeta.z + "px";
                }
                _this.calcLensSize();
    ...
    Object.defineProperty(NgxRedZoomDirective.prototype, "imagesLoaded", {
        get: /**
         * @return {?}
         */
        function () {
    ...
    Object.defineProperty(NgxRedZoomDirective.prototype, "draggable", {
        get: /**
         * @return {?}
         */
        function () {
     ...
     * @return {?}
     */
    NgxRedZoomDirective.prototype.listen = /**
     * @return {?}
     */
    function () {
        var _this = this;
    ...
    function () {
        ...
        function () {
            ...
            _this.template = _this.template2.template;
            _this.window = _this.template2.window;
            _this.windowBody = _this.template2.windowBody;
            _this.lens = _this.template2.lens;
            _this.lensBody = _this.template2.lensBody;
